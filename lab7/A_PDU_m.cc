...
int A_PDU::getDestiAdd() const
{
    return destiAdd_var;
}

void A_PDU::setDestiAdd(int destiAdd)
{
...
int A_PDUDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='d' && strcmp(fieldName, "destiAdd")==0) return base+2;
...
std::string A_PDUDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return long2string(pp->getDestiAdd());
...
bool A_PDUDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setDestiAdd(string2long(value)); return true;
